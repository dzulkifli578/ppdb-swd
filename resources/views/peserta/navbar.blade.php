...
@php
    $menu = [
        ['route' => 'peserta-dashboard', 'label' => 'Dashboard'],
        ['route' => 'peserta-biodata', 'label' => 'Biodata'],
        ['route' => 'peserta-pengumuman', 'label' => 'Pengumuman'],
        ['route' => 'peserta-status-penerimaan', 'label' => 'Status Penerimaan'],
    ];
@endphp
