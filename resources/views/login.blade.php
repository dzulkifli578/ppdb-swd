        ...
        <div class="basis-3 border boder-base-content rounded-xl p-6">
            ...
            <form action="{{ route('proses-login') }}" method="post" class="flex flex-col gap-y-4">
                ...
                <label class="input input-bordered input-accent flex items-center">
                    ...
                    <input type="text" name="nama_pengguna" class="grow ml-2" placeholder="Nama Pengguna" required />
                </label>
                <label class="input input-bordered input-accent flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                        class="h-4 w-4 opacity-70">
                    ...
                    <input type="password" name="kata_sandi" class="grow ml-2" placeholder="Kata Sandi" required />
                </label>
                <button type="submit" class="btn btn-primary font-semibold w-full mt-2">Kirim</button>
            </form>
        </div>
    </content>
