...
<body class="bg-class-100">
    ...
    <!-- Content -->
    <content>
        <div class="bg-base-300 flex flex-col justify-center items-center rounded-xl shadow-xl mx-6 my-6 p-6 gap-y-6">
            <div class="w-full flex flex-row justify-between items-center">
                <h2 class="text-base font-bold md:text-xl lg:text-2xl mr-6">Data Pendaftar</h2>
